...
import com.github.bgomar.bgdevtoys.tools.TimestampTools;
import com.github.bgomar.bgdevtoys.toolwindow.ComboBoxWithImageItem;
import com.github.bgomar.bgdevtoys.toolwindow.ComboBoxWithImageRenderer;
import com.github.bgomar.bgdevtoys.toolwindow.DevToysToolWindow;
    ...
    public void setup() {
        ...
        zoneIds.forEach(zoneId -> {
            ...
            timestampTimezoneComboBox.addItem(new ComboBoxWithImageItem(
                zoneId, "bgdevtoys/flags/" + flag + ".svg"));
        });
        ...
        timestampNowButton.setIcon(IconLoader.getIcon("bgdevtoys/toolicons/refresh.svg", DevToysToolWindow.class));
        timestampUpdateFromTimestampButton.setIcon(IconLoader.getIcon("bgdevtoys/toolicons/refresh.svg", DevToysToolWindow.class));
        timestampUpdateFromFieldsButton.setIcon(IconLoader.getIcon("bgdevtoys/toolicons/refresh.svg", DevToysToolWindow.class));
