package com.github.bgomar.consolebrowser.services

import com.github.bgomar.consolebrowser.settings.FavoritesWeb
import com.github.bgomar.consolebrowser.settings.HeadersOverwrite
...
class GivServiceSettings : PersistentStateComponent<GivServiceSettings.State> {
  ...
  class State {
    var homePage: String = "http://localhost:4200/"
